      ...
      <div v-show="showFlag" class="food" ref="foodScroll">
        <div class="food-content">
          ...
          <div class="rating">
            ...
            <v-ratingseller @select="selectRating"  @toggle="toggleContent"  :ratings="food.ratings" :selectType="selectType" :only-content="onlyContent" :desc="desc"></v-ratingseller>
